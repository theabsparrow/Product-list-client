...
const NavMobile = () => {
    ...
    return (
        <div className="font-poppins h-[70px] md:h-[120px] bg-teal-800 px-3 md:py-2 sticky top-0 z-20 shadow-xl">
            <div className="flex justify-between items-center  ">
                ...
                <div className={`${display ? "right-0 " : "hidden"} duration-1000 lg:hidden z-20 absolute top-[69px] md:top-[90px] space-y-3 flex flex-col items-start shadow-xl rounded-b-xl p-3 bg-teal-800 `}>
